...
cfg = Config(__name__='finetuning from latest pth flies')
...
cfg.dropout = 0.3
cfg.pretrain = 'exps/cmd_UCF-101_resnet26_2p1d/cmd_UCF-101_resnet26_2p1d_2022-06-17_00-59-40/epoch_200.pth' # pretrained model path
