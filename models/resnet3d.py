...
__all__ = ['ResNet3d', 'resnet10_3d', 'resnet18_3d', 'resnet26_3d', 'resnet34_3d',
           'resnet50_3d', 'resnet101_3d', 'resnet152_3d', 'resnet200_3d',
           'resnext50_32x4d_3d', 'resnext101_32x8d_3d', 'wide_resnet50_2_3d',
           'wide_resnet101_2_3d']
...
class ResNet3d(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=True,
        ...
        self.conv1 = nn.Conv3d(inplanes, self.inplanes, kernel_size=(3, 7, 7),
...
def resnext50_32x4d_3d(**kwargs):
    kwargs['groups'] = 32
    kwargs['width_per_group'] = 4
    return ResNet3d(Bottleneck, [3, 4, 6, 3], **kwargs)


def resnext101_32x8d_3d(**kwargs):
    kwargs['groups'] = 32
    kwargs['width_per_group'] = 8
    return ResNet3d(Bottleneck, [3, 4, 23, 3], **kwargs)


def wide_resnet50_2_3d(**kwargs):
    kwargs['width_per_group'] = 64 * 2
    return ResNet3d(Bottleneck, [3, 4, 6, 3], **kwargs)


def wide_resnet101_2_3d(**kwargs):
    kwargs['width_per_group'] = 64 * 2
    return ResNet3d(Bottleneck, [3, 4, 23, 3], **kwargs)
